...
function x(t) {
  return function(n) {
    ...
    if (typeof n == "object") {
      ...
      return v({ content: a, duration: s, type: t });
    }
...
const G = new ge();
function v({ duration: t, content: n, type: a }) {
...
function Ee() {
  ...
  return j.Fragment = n, j.jsx = a, j.jsxs = a, j;
}
var P = {};
/**
 * @license React
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (m = null, i !== void 0 && (a(i), m = "" + i), l(r) && (a(r.key), m = "" + r.key), "key" in r) {
        i = {};
        for (var D in r)
          D !== "key" && (i[D] = r[D]);
      } else i = r;
    ...
    P.Fragment = p, P.jsx = function(e, r, i, f, T) {
...
const pe = "_screenRightIn_1m461_1", Te = "_screenCenterIn_1m461_1", ve = "_screenLeftIn_1m461_1", Se = "_success_1m461_114", ke = "_info_1m461_119", Ae = "_warn_1m461_124", Oe = "_error_1m461_129", Ce = "_ghost_1m461_134", we = "_screenOut_1m461_1", k = {
...
function ye({
  ...
  function c() {
    const E = M(l), y = M(_), O = R(), Y = k[`animation-message-${o == null ? void 0 : o.toastPosition}`];
...
function xe({
  ...
  var R, S;
  const s = (R = t == null ? void 0 : t.toastContainer) == null ? void 0 : R["*"], u = (S = t == null ? void 0 : t.toastContainer) == null ? void 0 : S[a], [o, l] = re([]);
  function _() {
    const c = M(s), d = M(u);
    return `${k["toast-container"]} ${k[a]} ${d} ${c}`.trim();
  }
  function h() {
    return { ...$(s), ...$(u) };
  }
