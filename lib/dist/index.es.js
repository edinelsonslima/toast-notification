...
var _e = (t, n, a) => n in t ? le(t, n, { enumerable: !0, configurable: !0, writable: !0, value: a }) : t[n] = a;
var Q = (t, n, a) => _e(t, typeof n != "symbol" ? n + "" : n, a);
...
class ge {
  ...
  on(n, a) {
    var s;
    this.listeners.has(n) || this.listeners.set(n, []), (s = this.listeners.get(n)) == null || s.push(a);
  }
  emit(n, a) {
    var s;
    this.listeners.has(n) && ((s = this.listeners.get(n)) == null || s.forEach((u) => u(a)));
  }
  removeListener(n, a) {
...
function x(t) {
  return function(n) {
    if (te(n))
      return k({ content: n, type: t });
    const { content: a, duration: s } = n;
    return k({ content: a, duration: s, type: t });
  };
}
function be(t) {
  if (t)
...
const G = new ge();
function k({ duration: t, content: n, type: a }) {
  n = be(n), G.emit("add-toast", { content: n, duration: t, type: a });
}
k.error = x("error");
k.success = x("success");
k.warn = x("warn");
...
function he() {
  return N || (N = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function a(e) {
      ...
      if (r) {
        r = console;
        var i = r.error, m = typeof Symbol == "function" && Symbol.toStringTag && e[Symbol.toStringTag] || e.constructor.name || "Object";
        return i.call(
          r,
    ...
    function R(e, r, i, m, T, g, W, F) {
      ...
      if (z.call(r, "key")) {
        f = t(e);
        var C = Object.keys(r).filter(function(fe) {
          return fe !== "key";
        });
        m = 0 < C.length ? "{key: someKey, " + C.join(": ..., ") + ": ...}" : "{key: someKey}", Z[f + m] || (C = 0 < C.length ? "{" + C.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (f = null, i !== void 0 && (a(i), f = "" + i), l(r) && (a(r.key), f = "" + r.key), "key" in r) {
        i = {};
        for (var D in r)
          D !== "key" && (i[D] = r[D]);
      } else i = r;
    ...
    j.Fragment = p, j.jsx = function(e, r, i, m, T) {
...
const pe = "_screenRightIn_1m461_1", Te = "_screenCenterIn_1m461_1", ve = "_screenLeftIn_1m461_1", Se = "_success_1m461_114", ke = "_info_1m461_119", Ae = "_warn_1m461_124", Oe = "_error_1m461_129", Ce = "_ghost_1m461_134", we = "_screenOut_1m461_1", S = {
...
function ye({
  message: { duration: t = 1e3 * 7, id: n, content: a, type: s },
  onRemoveMessage: u,
  classNames: o
}) {
  var p, A;
  const l = (p = o == null ? void 0 : o.toastMessages) == null ? void 0 : p["*"], _ = (A = o == null ? void 0 : o.toastMessages) == null ? void 0 : A[s], [h, w] = re(void 0);
  function R() {
    return h ? S[h] ? S[h] : h : "";
  }
  function v(E) {
  ...
  function c() {
    const E = M(l), y = M(_), O = R(), Y = S[`animation-message-${o == null ? void 0 : o.toastPosition}`];
    return `${S["toast-message"]} ${S[s]} ${Y} ${O} ${y} ${E}`.trim();
  }
  function d() {
    return { ...$(l), ...$(_) };
  }
...
function xe({
  ...
  var R, v;
  const s = (R = t == null ? void 0 : t.toastContainer) == null ? void 0 : R["*"], u = (v = t == null ? void 0 : t.toastContainer) == null ? void 0 : v[a], [o, l] = re([]);
  function _() {
    const c = M(s), d = M(u);
    return `${S["toast-container"]} ${S[a]} ${d} ${c}`.trim();
  }
  function h() {
    return { ...$(s), ...$(u) };
  }
  ...
  return oe(() => {
    function c(d) {
      const { content: b, type: p, duration: A = n } = d;
      l((E) => [
        ...E,
        { id: crypto.randomUUID(), content: b, duration: A, type: p }
      ]);
    }
